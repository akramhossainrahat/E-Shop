...
@section('home')
    ...
    <div class="span9">
                ...
                <div class="span5">
                    <div id="myCarousel" class="carousel slide cntr">
                        <div class="carousel-inner">
                            ...
                            <div class="item">
                                <a href="#"> {{ HTML::image("$productdetails->product_image") }}</a>
                            </div>
                            <div class="item">
                                <a href="#"> {{ HTML::image("$productdetails->product_image") }}</a>
                            </div>
                ...
                <div class="span7">
                    ...
                    <form class="form-horizontal qtyFrm">
                        <div class="control-group">
                            <label class="control-label"><span>${{$productdetails->product_price}}</span></label>
                            <div class="controls">
                                <input class="span6" placeholder="Qty." type="number">
                            </div>
                        </div>
        ...
        <div class="well">
            <form class="form-horizontal" action="{{URL::to('save-feedback')}}" method="post">
                {{csrf_field()}}
                <h3>Reviews</h3>
                <div class="control-group">
                    <label class="control-label">Name<sup>*</sup></label>
                    <div class="controls">
                        <input placeholder="Your name here..." type="text" name="cust_name">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                        <input placeholder="Your email here..." type="email" name="cust_email">
                    </div>
                </div>
                <div class="control-group">
                    <label class="control-label">Feedback<sup>*</sup></label>
                    <div class="controls">
                        <textarea name="cust_feedback"></textarea>
                    </div>
                </div>
                <div class="control-group">
                    <div class="controls">
                        <input name="submitAccount" value="Submit" class="shopBtn exclusive" type="submit">
                    </div>
                </div>
            </form>
        </div>
