...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <a href="index2.html" class="logo">
            ...
            <span class="logo-lg"><b>E</b>-Shop</span>
        </a>
            ...
            <div class="navbar-custom-menu">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="dist/img/galaxy.png" class="user-image" alt="User Image">
                            <span class="hidden-xs">Akram Hossain Rahat</span>
                        </a>
                        <ul class="dropdown-menu">
                            <!-- User image -->
                            <li class="user-header">
                                <img src="dist/img/galaxy.png" class="img-circle" alt="User Image">

                                <p>
                                    Akram Hossain Rahat - Web Developer
    ...
    <footer class="main-footer">
        ...
        <strong>Copyright &copy; 2018 <a href="https://facebook.com/akramhossain.rahat">Akram Hossain Rahat</a>.</strong> All rights
        reserved.
    </footer>
